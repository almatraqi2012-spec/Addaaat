...
def start_main(m):
    ...
    bot.send_message(uid, "🐲 **مرحباً بكم في بوت دراجون المطور الاسعار .. 1000 عضو=7دولار فقط! **\اسحب الأعضاء من أي مجموعة وضعهم في مجموعتك بضغطة زر -   100%.", reply_markup=mk)
